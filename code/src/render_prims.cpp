...
namespace MyLoadedModel {
	extern void setupModel(ObjType TypeObj);
	extern void cleanupModel(ObjType TypeObj);
	extern void updateModel(const glm::mat4& transform, ObjType TypeObj);
	extern void drawModel(double currentTime, ObjType TypeObj);
}
